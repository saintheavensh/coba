<script lang="ts">
    ...
    import SupplierList from "./components/supplier-list.svelte";
    import PurchaseList from "./components/purchase-list.svelte";
</script>

<div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold tracking-tight">Manajemen Produk</h1>
            <p class="text-muted-foreground">
                Kelola produk, kategori, supplier, dan riwayat pembelian.
            </p>
        </div>
    </div>
