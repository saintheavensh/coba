<script lang="ts">
    ...
    import { TicketDetailController } from "$lib/features/service-management/tickets/ticket-detail.controller.svelte";
    import TicketHeader from "$lib/features/service-management/tickets/components/ticket-detail/TicketHeader.svelte";
    import TicketSidebar from "$lib/features/service-management/tickets/components/ticket-detail/TicketSidebar.svelte";
    import CustomerCard from "$lib/features/service-management/tickets/components/ticket-detail/cards/CustomerCard.svelte";
    import DeviceCard from "$lib/features/service-management/tickets/components/ticket-detail/cards/DeviceCard.svelte";
    import ConditionCard from "$lib/features/service-management/tickets/components/ticket-detail/cards/ConditionCard.svelte";
    import SecurityCard from "$lib/features/service-management/tickets/components/ticket-detail/cards/SecurityCard.svelte";
    ...
    import ServiceModals from "$lib/features/service-management/tickets/components/ticket-detail/modals/ServiceModals.svelte";
