<script lang="ts">
    ...
    import { BrandsService, type Brand } from "$lib/features/inventory/services/brands.service";
    ...
    import { Card, CardContent, CardFooter } from "$lib/shared/components/ui/card";
