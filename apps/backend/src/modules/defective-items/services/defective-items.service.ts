import { DefectiveItemsModel } from "../models/defective-items.model";
import { db } from "../../../db";
...
export class DefectiveItemsService {
    private model: DefectiveItemsModel;

    constructor() {
        this.model = new DefectiveItemsModel();
    }
    ...
    async getPendingItems() {
        return await this.model.findAll("pending");
    }
